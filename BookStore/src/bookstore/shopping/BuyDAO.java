	...
	public void insertBuy(List<CartDTO> lists, String id, String account, 
		...
		try {
			...
			for(int i = 0; i < lists.size(); i++) {
				...
				//장바구니에 있는 상품이 구매되었으므로 book테이블에 있는 상품의 수량을 재조정해야한다.
...
//----------------------------------------------------------------------------------------------
//모든 테이블에 대한 작업이 끝났으므로 commit을 실행한다.
//----------------------------------------------------------------------------------------------
			conn.commit();
