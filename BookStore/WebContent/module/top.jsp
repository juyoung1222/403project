		...
		<div>
			...
			<div class="form-group collapse navbar-collapse" id="#myNavbar" >
				<form class="navbar=form navbar-right" method="post" action="../shopping/logon/loginPro.jsp">
					...
					<span class="glyphicon glyphicon-list-alt"></span>책방 둘러보기</a>
					<button type="submit" class="btn btn-primary">
						<span class="glyphicon glyphicon-log-in"></span>로그인
					</button>
					<a href="../shopping/member/memberInsertForm.jsp" class="btn btn-dangerous" aria-pressed="true">
			...
			<div class="container-fluid">
				...
				<div>
					...
					<div class="form-group collapse navbar-collapse navbar-right" id="myNavbar">
						...
						<span class="glyphicon glyphicon-eye-open">카트목록보기</span></a>
						
						<a href="../shopping/cartList.jsp" class="btn btn-primary" aria-pressed="true">
						<span class="glyphicon glyphicon-shopping-cart">장바구니</span></a>
						
						<a href="../shopping/cartList.jsp" class="btn btn-primary" aria-pressed="true">
						<span class="glyphicon glyphicon-shopping-cart">장바구니2</span></a>
						
						<a href="../shopping/buyList.jsp" class="btn btn-warning" aria-pressed="true">
						<span class="glyphicon glyphicon-list-alt">구매목록보기</span></a>
						...
						<a href="../shopping/logon/logout.jsp" class="btn btn-dangerous" aria-pressed="true">
						<span class="glyphicon glyphicon-log-out">로그아웃</span></a>
					</div>
				</div>	
			</div>
		</nav>
