...
<head>
	...
	<title>년도별 따른 월별 판매량</title>
</head>
<body>

	<div class="container">
		<h4 align="center"><b>월별 판매 현황</b></h4>
		<form class="form-horizontal" method="post" name="monthBarStatsForm" action="monthBarStatsForm.jsp">
			<div class="form-group">
				<div class="col-sm-1">
					<h4><span class="label label-info">검색년도</span></h4>		
				</div>
				<div class="col-sm-2">
					<input type="text" class="form-control" id="year" name="year" placeholder="EnterYear"/>
				</div>
				<div class="col-sm-2">
					<input class="btn btn-danger btn-sm" type="submit" value="검색하기" action="javascript:window.location='monthBarStatsForm.jsp'"/>
					<input class="btn btn-info btn-sm" type="button" value="메인으로" onclick="javascript:window.location='../managerMain.jsp'"/>
 				</div>	
			</div>
