...
<div class="container-fluid" 
	style="background-color:#F44336; height:200px;">
	<h1>쇼 핑 몰 관 리</h1>
	<h3>관리자가 쇼핑몰에 관한 모든것을 관리하는 페이지 입니다.</h3>
					...
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="product/bookList.jsp?book_kind=all">상품목록(수정/삭제)</a></li> <!--all은 모든 데이터를 말함.  -->
							</ul>
						</li>
						<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#">
							...
							<ul class="dropdown-menu">
								<li><a href="statistics/monthStatsForm.jsp">월별 판매리스트(꺽은 선)</a></li>
								<li><a href="statistics/monthBarStatsForm.jsp">월별 판매 리스트(막대)</a></li> <!--all은 모든 데이터를 말함.  -->
