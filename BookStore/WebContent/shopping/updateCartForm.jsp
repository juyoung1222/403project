...
<jsp:include page="../module/top.jsp"/>
	...
	<div class="container">
		...
		<form class="form-inline" method="POST" name="updateForm">
			<div class="form-group">
				...
				<input type="text" class="form-control" name="buy_count" size="4" value = "<%=buy_count %>" placeholder="구매수량"/>
				...
				onclick="cartUpdate();return false;" onFocus="this.blur()"/><!--onFocus="this.blur()"링크를 걸은 이미지 클릭할시 점선모양의 테두리가 생기는데 그걸 없앨때 사용 -->
	...
	<script src="../bsfunction.js"></script>
