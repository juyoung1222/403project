...
<div class="container">
	<!-- 회원가입 자료를 입력할 폼을 만든다. -->
	<!-- 입력할 정보=>아이디,비밀번호,비밀번호확인,이름,주소,전화번호 -->
	<form class="form-horizontal" name="memInsForm" action="memberInsertPro.jsp"
		method="post">
		<div class="form-group">
			...
			<div class="col-sm-2">
				<input type="text" class="form-control" id="id" 
					name="id" maxlength="16" placeholder="아이디">
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<input type="password" class="form-control" maxlength="20"
					name="repasswd" placeholder="비밀번호확인"/>
				</div>
			</div>
			<div class="form-group">
